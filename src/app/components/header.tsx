  ...
  return (
    ...
    <div>
      <header className="header flex top-header py-4 bg-white text-black text-center my-2">
        ...
        <div className="logo-container flex ml-8 sm:ml-12">
          <Image
            className="logo mt-1"
            src="/logo.png"
            alt="img"
        ...
        <div className="icon-container flex ml-44 mt-3 gap-10">
         ...
         {/* Mobile Menu Button */}
        <button className="menu-toggle ml-4 mr-4 sm:mr-6" onClick={() => setMenuOpen(!menuOpen)}>☰</button>
      ...
      <div
        className={`group fixed top-20 right-0 w-80 h-full bg-white shadow-lg transition-transform duration-30000 ${
